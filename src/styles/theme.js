...
const titleColor = COLOR_PALLETE.textBase[900];

export default createTheme({
  palette: {
    primary: {
      all: COLOR_PALLETE.primary,
      main: COLOR_PALLETE.primary[900],
      contrastText: "#fff",
    },
    secondary: {
      all: COLOR_PALLETE.secondary,
      main: COLOR_PALLETE.secondary[700],
      contrastText: "#fff",
    },
    fillContrast: {
      main: "#fff",
